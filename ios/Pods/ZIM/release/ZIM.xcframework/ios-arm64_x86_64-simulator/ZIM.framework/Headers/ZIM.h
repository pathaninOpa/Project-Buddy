...
+ (void)setCustomDispatchQueue:(nonnull dispatch_queue_t)queue;
...
- (void)updateUserCustomStatus:(NSString *)customStatus
                      callback:(ZIMUserCustomStatusUpdatedCallback)callback;
...
//修改离线推送的自定参数
- (void)updateUserOfflinePushRule:(ZIMUserOfflinePushRule *)offlinePushRule
                         callback:(ZIMUserOfflinePushRuleUpdatedCallback)callback;
//查询接口
- (void)querySelfUserInfo:(ZIMSelfUserInfoQueriedCallback)callback;

- (void)queryUsersStatusByUserIDs:(NSArray<NSString *> *)userIDs
                         callback:(ZIMUsersStatusQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryUsersStatus(by:callback:));
// clang-format on

- (void)subscribeUsersStatus:(NSArray<NSString *> *)userIDs
                      config:(ZIMUserStatusSubscribeConfig *)config
                    callback:(ZIMUsersStatusSubscribedCallback)callback;

- (void)unsubscribeUsersStatus:(NSArray<NSString *> *)userIDs
                      callback:(ZIMUsersStatusUnsubscribedCallback)callback;

- (void)querySubscribedUserStatusListWithConfig:(ZIMSubscribedUserStatusQueryConfig *)config
                                       callback:(ZIMSubscribedUserStatusListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(querySubscribedUserStatusList(with:callback:));
// clang-format on
// MARK: - Conversation
...
- (void)queryConversationListWithConfig:(ZIMConversationQueryConfig *)config
                                 option:(ZIMConversationFilterOption *)option
                               callback:(ZIMConversationListQueriedCallback)callback;
...
- (void)
    queryConversationTotalUnreadMessageCountWithConfig:
...
- (void)setConversationMark:(NSNumber *)markType
                     enable:(BOOL)enable
          conversationInfos:(NSArray<ZIMConversationBaseInfo *> *)conversationInfos
                   callback:(ZIMConversationMarkSetCallback)callback
    // clang-format off
NS_SWIFT_NAME(setConversationMark(_:enable:conversationInfos:callback:));
// clang-format on
...
- (void)sendMediaMessage:(ZIMMediaMessage *)message
        ...
        conversationType:(ZIMConversationType)conversationType
            ...
            notification:(nullable ZIMMediaMessageSendNotification *)notification
                callback:(ZIMMessageSentCallback)callback
    DEPRECATED_MSG_ATTRIBUTE("Deprecated since ZIM 2.19.0, please use [sendMessage] instead")
    // clang-format off
...
- (void)downloadMediaFileWithMessage:(ZIMMessage *)message
                            fileType:(ZIMMediaFileType)fileType
                              config:(ZIMMediaDownloadConfig *)config
                            progress:(ZIMMediaDownloadingProgress)progress
                            callback:(ZIMMediaDownloadedCallback)callback;
...
- (void)queryMessagesByMessageSeqs:(NSArray<NSNumber *> *)messageSeqs
                    conversationID:(NSString *)conversationID
                  conversationType:(ZIMConversationType)conversationType
                          callback:(ZIMMessageQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryMessages(by:conversationID:conversationType:callback:));
// clang-format on
...
- (void)replyMessage:(ZIMMessage *)message
    toOriginalMessage:(ZIMMessage *)toOriginalMessage
               config:(ZIMMessageSendConfig *)config
         notification:(nullable ZIMMessageSendNotification *)notification
             callback:(ZIMMessageSentCallback)callback
    // clang-format off
NS_SWIFT_NAME(replyMessage(_:toOriginalMessage:config:notification:callback:));
// clang-format on

- (void)editMessage:(ZIMMessage *)message
             config:(ZIMMessageEditConfig *)config
       notification:(nullable ZIMMessageSendNotification *)notification
           callback:(ZIMMessageEditedCallback)callback
    // clang-format off
NS_SWIFT_NAME(editMessage(_:config:notification:callback:));
// clang-format on

- (void)cancelSendingMessage:(ZIMMessage *)message
                      config:(ZIMSendingMessageCancelConfig *)config
                    callback:(ZIMSendingMessageCancelledCallback)callback
    // clang-format off
NS_SWIFT_NAME(cancelSendingMessage(_:config:callback:));
// clang-format on

- (void)queryMessageRepliedListByMessage:(ZIMMessage *)message
                                  config:(ZIMMessageRepliedListQueryConfig *)config
                                callback:(ZIMMessageRepliedListQueriedCallback)callback
    // clang-format off
NS_SWIFT_NAME(queryMessageRepliedList(by:config:callback:));
// clang-format on
...
- (void)importLocalMessagesFromFolderPath:(NSString *)folderPath
                                   config:(ZIMMessageImportConfig *)config
                                 progress:(ZIMMessageImportingProgress)progress
                                 callback:(ZIMMessageImportedCallback)callback;

- (void)exportLocalMessagesToFolderPath:(NSString *)folderPath
                                 config:(ZIMMessageExportConfig *)config
                               progress:(ZIMMessageExportingProgress)progress
                               callback:(ZIMMessageExportedCallback)callback;

- (void)clearLocalFileCacheWithConfig:(ZIMFileCacheClearConfig *)config
                             callback:(ZIMFileCacheClearedCallback)callback;

- (void)queryLocalFileCacheWithConfig:(ZIMFileCacheQueryConfig *)config
                             callback:(ZIMFileCacheQueriedCallback)callback;
...
- (void)switchRoomFromRoomID:(NSString *)roomID
                    toRoomInfo:(ZIMRoomInfo *)toRoomInfo
    isCreateWhenRoomNotExisted:(BOOL)isCreateWhenRoomNotExisted
                        config:(ZIMRoomAdvancedConfig *)config
                      callback:(ZIMRoomSwitchedCallback)callback;
...
- (void)updateGroupAlias:(NSString *)groupAlias
                 groupID:(NSString *)groupID
                callback:(ZIMGroupAliasUpdatedCallback)callback;
...
- (void)updateGroupJoinMode:(ZIMGroupJoinMode)mode
                    groupID:(NSString *)groupID
                   callback:(ZIMGroupJoinModeUpdatedCallback)callback;

- (void)updateGroupInviteMode:(ZIMGroupInviteMode)mode
                      groupID:(NSString *)groupID
                     callback:(ZIMGroupInviteModeUpdatedCallback)callback;

- (void)updateGroupBeInviteMode:(ZIMGroupBeInviteMode)mode
                        groupID:(NSString *)groupID
                       callback:(ZIMGroupBeInviteModeUpdatedCallback)callback;
...
- (void)sendGroupJoinApplicationToGroupID:(NSString *)groupID
                                   config:(ZIMGroupJoinApplicationSendConfig *)config
                                 callback:(ZIMGroupJoinApplicationSentCallback)callback;

- (void)acceptGroupJoinApplicationFromUserID:(NSString *)userID
                                     groupID:(NSString *)groupID
                                      config:(ZIMGroupJoinApplicationAcceptConfig *)config
                                    callback:(ZIMGroupJoinApplicationAcceptedCallback)callback;

- (void)rejectGroupJoinApplicationFromUserID:(NSString *)userID
                                     groupID:(NSString *)groupID
                                      config:(ZIMGroupJoinApplicationRejectConfig *)config
                                    callback:(ZIMGroupJoinApplicationRejectedCallback)callback;

- (void)sendGroupInviteApplicationsToUserIDs:(NSArray<NSString *> *)userIDs
                                     groupID:(NSString *)groupID
                                      config:(ZIMGroupInviteApplicationSendConfig *)config
                                    callback:(ZIMGroupInviteApplicationsSentCallback)callback;

- (void)
    acceptGroupInviteApplicationFromInviterUserID:(NSString *)inviterUserID
                                          groupID:(NSString *)groupID
                                           config:(ZIMGroupInviteApplicationAcceptConfig *)config
                                         callback:
                                             (ZIMGroupInviteApplicationAcceptedCallback)callback;

- (void)
    rejectGroupInviteApplicationFromInviterUserID:(NSString *)inviterUserID
                                          groupID:(NSString *)groupID
                                           config:(ZIMGroupInviteApplicationRejectConfig *)config
                                         callback:
                                             (ZIMGroupInviteApplicationRejectedCallback)callback;

- (void)queryGroupApplicationListWithConfig:(ZIMGroupApplicationListQueryConfig *)config
                                   callback:(ZIMGroupApplicationListQueriedCallback)callback;
