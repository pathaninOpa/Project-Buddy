...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_callkit_incoming/flutter_callkit_incoming.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_logs_yoer/flutter_logs_yoer.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_native_splash/flutter_native_splash.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_ringtone_player/flutter_ringtone_player.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_volume_controller/flutter_volume_controller.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/proximity_sensor/proximity_sensor.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/zego_callkit/zego_callkit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zego_uikit_prebuilt_call/zego_uikit_prebuilt_call.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zego_uikit_signaling_plugin/zego_uikit_signaling_plugin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zego_zim/zego_zim.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/zego_zpns/zego_zpns.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/zego_express_engine/ZegoExpressEngine.framework"
fi
