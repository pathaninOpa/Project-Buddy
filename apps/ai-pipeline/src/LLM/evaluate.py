...
กรุณาให้คะแนนแต่ละโมเดลเป็นตัวเลข 1-10 โดยใช้รูปแบบดังนี้:

คะแนน A (gemma3:4b): XX
คะแนน B (gemma3:27b): XX

ห้ามใส่คำอธิบายเพิ่มเติม ให้ตอบกลับด้วยบรรทัดคะแนนสองบรรทัดเท่านั้น
"""
